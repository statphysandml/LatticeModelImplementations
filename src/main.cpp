...
void custom_main()
{
    ...
    // c)
    // By running:
    //     ./LatticeModelImplementations expectation_value ONModelMetropolis
...
// Rerun the simulation with ./LatticeModelImplementations expectation_value ONModelMetropolis
