...
namespace from_file_simulation {
    ...
    typedef lm_impl::mcmc_method::ComplexLangevinUpdateParameters<ModelParams, lm_impl::sampler::GaussianSampler> MCMCMethodParams;
    typedef lm_impl::update_dynamics::UpdateWithAdpativeStepsizeParameters UpdateDynamicsParams;
    typedef lm_impl::site_system::SiteParameters< BasicType, ModelParams, MCMCMethodParams, UpdateDynamicsParams> SystemBaseParams;
}
