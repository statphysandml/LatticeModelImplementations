...
namespace complex_monte_carlo_measures
{
    ...
    struct MeasureDetailedBalanceAccuracyPolicy : public common_measures::MeasurePolicy<SB> {
    public:
        ...
        SiteSystem<typename SB::SiteType, typename SB::ModelType, DummyMCMCUpdateParameters, DummyUpdateDynamicsParameters> system_repr;
    };

    template<typename SB>
    struct MeasureAbsoluteDetailedBalanceAccuracyPolicy : public common_measures::MeasurePolicy<SB> {
    public:
        // ToDo: Introduce possibility to use this also without defining model_params_path
        explicit MeasureAbsoluteDetailedBalanceAccuracyPolicy(const json &system_repr_params_, const typename SB::SiteType &prev_site_) :
                prev_site(prev_site_), system_repr(
                SiteSystem<typename SB::SiteType, typename SB::ModelType, DummyMCMCUpdateParameters, DummyUpdateDynamicsParameters>::from_json(
                        json {{"mcmc_update_params", {{"eps", 0.0}}}, {"model_params_path", system_repr_params_["model_params_path"]}}, "None"))
        {}
    ...
    template<typename SB>
    struct MeasureRealStepSizePolicy : public common_measures::MeasurePolicy<SB> {
    public:
    ...
    template<typename SB>
    struct MeasureImagStepSizePolicy : public common_measures::MeasurePolicy<SB> {
    public:
    ...
    template<typename SB>
    struct MeasureComplexStepSizePolicy : public common_measures::MeasurePolicy<SB> {
    public:
