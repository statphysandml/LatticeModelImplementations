...
{
    explicit ParallelUpdateWithAdpativeStepsizeParameters(const json params_) : UpdateDynamicsBaseParameters(params_)
    {
    ...
    typedef ParallelUpdateWithAdpativeStepsize UpdateDynamics; //  LatticeUpdate;
