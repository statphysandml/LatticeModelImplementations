...
template<typename ModelParameters>
class MetropolisUpdateParameters : public LocalUpdateFormalismParameters {
public:
    explicit MetropolisUpdateParameters(const json params_) : LocalUpdateFormalismParameters(params_)
    {}
    ...
    typedef MetropolisUpdate<ModelParameters> UpdateFormalism;
...
template<typename ModelParameters>
class MetropolisUpdate : public LocalUpdateFormalism< MetropolisUpdate<ModelParameters> >
{
public:
