...
template<typename ModelParameters>
class ComplexLangevinUpdateParameters : public LocalUpdateFormalismParameters {
public:
    explicit ComplexLangevinUpdateParameters(const json params_) : LocalUpdateFormalismParameters(params_),
    ...
    typedef ComplexLangevinUpdate<ModelParameters> UpdateFormalism;
...
template<typename ModelParameters>
class ComplexLangevinUpdate : public LocalUpdateFormalism< ComplexLangevinUpdate<ModelParameters> >
{
public:
