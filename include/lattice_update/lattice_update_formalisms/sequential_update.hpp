...
struct SequentialUpdateParameters : LatticeUpdateParameters
{
    explicit SequentialUpdateParameters(const json params_) : LatticeUpdateParameters(params_)
    {}
    ...
    typedef SequentialUpdate LatticeUpdate;
};

struct SequentialUpdate : public LatticeUpdate<SequentialUpdate>
{
