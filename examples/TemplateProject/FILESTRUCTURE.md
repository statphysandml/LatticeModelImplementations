...
* C++ source files:
  * `include/ONModel2/ONModel2.hpp` is the main
    C++ header that declares the interface of your library.
  * `src/ONModel2.cpp` is the main file that implements this library.
  * `app/ONModel2_app.cpp` is an executable that uses the library.
