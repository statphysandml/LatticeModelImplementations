...
namespace from_file_simulation {
    ...
    typedef lm_impl::link_lattice_system::U1ModelParameters ModelParams;
    typedef lm_impl::mcmc_method::MetropolisUpdateParameters<ModelParams, lm_impl::link_lattice_system::U1ModelSampler> MCMCMethodParams;
