#include "../include/XYModel/config.h"
...
int main(int argc, char **argv) {
    ...
    const std::string target_name = "XYModelHMC";
    ...
    typedef lm_impl::lattice_system::XYModel MCMCModel;

    typedef double BasicType;
    typedef lm_impl::sampler::GaussianSampler Sampler;
    typedef lm_impl::mcmc_method::HybridMonteCarloUpdate<BasicType, MCMCModel> MCMCMethod;
    typedef lm_impl::update_dynamics::GlobalSystemUpdate UpdateDynamics;
    ...
    MCMCMethod mcmc_method(0.02, 20);
    ...
    ExpectationValueParams expectation_value_parameters(
        ...
        {"XYMagnetization", "Config", "Energy"}, // measures
        {}, // post_measures
        "hot", // starting_mode
