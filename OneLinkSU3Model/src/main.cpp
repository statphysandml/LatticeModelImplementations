#include "../include/OneLinkSU3Model/config.h"
...
#include <lattice_model_impl/sampler/su3_sampler.hpp>
...
int main(int argc, char **argv) {
    ...
    const std::string target_name = "OneLinkSU3ModelComplexLangevin";
    ...
    typedef lm_impl::link::OneLinkSU3 BasicType;
    ...
    MCMCModel model(2.0, 0.0, 0.0, 0.0, 0.5, 0.0);
    ...
    ExpectationValueParams expectation_value_parameters(
        1000, // correlation_time_rel_results_dir
        10000, //  number_of_measurements
        10000, // equilibrium_time_rel_results_dir
        {"Polyakov_Loop", "Conjugate_Polyakov_Loop", "Polyakov_Loop_real"}, // measures
        {}, // post_measures
        "hot", // starting_mode
