#include "../include/PolynomialModel/config.h"
...
int main(int argc, char **argv) {
    ...
    const std::string target_name = "PolynomialModelLangevin";
    ...
    typedef lm_impl::mcmc_method::LangevinUpdate<MCMCModel> MCMCMethod;
    ...
    ExpectationValueParams expectation_value_parameters(
        ...
        1000000, //  number_of_measurements
